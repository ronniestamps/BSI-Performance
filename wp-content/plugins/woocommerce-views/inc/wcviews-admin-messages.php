...
array(
		...
		/** WOOCOMMERCE SORTING SECTION TEXT */
		'woocommerce_sorting' =>
		array(
				// Tooltip title
				
				'title' => htmlentities( __('Frontend Sorting', 'woocommerce_views'), ENT_QUOTES ),
				
				// Tooltip content /
				
				'content' => htmlentities( __('By default, use WooCommerce built-in sorting in product archives. If you want to build your own sorting solution using Toolset front-end sorting controls, then un-check this setting.', 'woocommerce_views'), ENT_QUOTES ),
